...
$config['sess_samesite'] = 'None'; // ✅ Required for cross-origin requests
$config['sess_expiration'] = 7200;
$config['sess_save_path'] = sys_get_temp_dir(); // ✅ Ensure this path is writable
...
$config['allowed_origins'] = ['http://localhost:8101', '*'];
